...
- `acceptance_main`：100；`challenge_dev`：25；`blind_holdout`：0
...
|Blind Holdout Accuracy|0.00% (0/0)|
|Blind Holdout Positive Exact Match|0.00% (0/0)|
|Blind Holdout NIL Accuracy|0.00% (0/0)|
...
|分组|正确 / 总数|准确率|
|-|-:|-:|
|`cross_sentence`|4 / 7|57.14%|
|`legacy`|257 / 257|100.00%|
|`no_gold_antecedent`|24 / 24|100.00%|
|`same_sentence`|90 / 94|95.74%|
